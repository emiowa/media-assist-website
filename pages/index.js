                ...
                <div>
                    ...
                    <div className='mx-auto max-w-7xl px-3 pt-20 pb-36 sm:px-24'>
                        <div className='pb-20 animateNotActive' ref={fadeInUpRef1}>
                            <p className='text-media-black font-bold text-3xl pb-2 sm:text-5xl sm:pb-4'>私たちについて</p>
                            <p className='text-media-black font-medium text-2xl pb-6 sm:text-4xl'>Media Assistについて</p>
                        ...
                        <div className='flex justify-center pt-14 animateNotActive' ref={fadeInUpRef3}>
                            <button type='button' className='relative inline-flex items-center justify-center rounded-md py-3 px-8 text-lg text-media-black border border-media-black font-medium hover:text-media-white hover:drop-shadow-md hover:border-indigo-600 hover:bg-gradient-to-tr hover:from-indigo-600 hover:to-indigo-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-media-white' onClick={aboutUsPageButton}>もっと見る</button>
                        </div>
                    </div>
                </div>
            </Layout>
