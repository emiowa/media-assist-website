            ...
            <Layout>
                <div className='dark:bg-media-black'>
                    <div className='mx-auto max-w-7xl px-3 sm:px-24'>
                        <div className="pt-32 sm:h-screen sm:grid sm:grid-cols-2 sm:items-center sm:pt-10">
                            <div>
                        ...
                        <div className="bg-gradient-to-tr from-indigo-200 to-indigo-100 rounded-3xl drop-shadow-lg py-10 px-3 sm:px-0 sm:rounded-bglg animateNotActive dark:bg-gradient-to-tr dark:from-indigo-900 dark:to-indigo-800" ref={slideInLeftRef1}>
                            ...
                            <div className="flex flex-col items-center text-center sm:text-left">
                                <div className='pb-3 leading-loose sm:flex sm:pb-0'>
                                    ...
                                    <p className='text-media-black text-lg sm:pl-2 dark:text-media-white'>株式会社メディアアシスト</p>
                                </div>
                                <div className='pb-3 leading-loose sm:flex sm:pb-0'>
                                    <p className='font-medium text-media-black text-lg dark:text-media-white'>代表者:</p>
                                    <p className='text-media-black text-lg sm:pl-2 dark:text-media-white'>松城　麻以子</p>
                                </div>
                                <div className='pb-3 leading-loose sm:flex sm:pb-0'>
                                    <p className='font-medium text-media-black text-lg dark:text-media-white'>所在地:</p>
                                    {/* Text for laptop and desktop screens */}
                                    <p className='hidden sm:flex sm:text-media-black sm:text-lg sm:pl-2 dark:text-media-white'>〒170-6045　東京都豊島区東池袋3-1-1　サンシャイン60 45階</p>
                                    {/* Text for mobile screens */}
                                    <p className='text-media-black text-lg sm:hidden dark:text-media-white'>〒170-6045　東京都豊島区東池袋3-1-1<br />サンシャイン60 45階</p>
                                </div>
                                <div className='pb-3 leading-loose sm:flex sm:pb-0'>
                                    <p className='font-medium text-media-black text-lg dark:text-media-white'>資本金:</p>
                                    <p className='text-media-black text-lg sm:pl-2 dark:text-media-white'>500万円</p>
                                </div>
                                <div className='pb-3 leading-loose sm:flex sm:pb-0'>
                                    <p className='font-medium text-media-black text-lg dark:text-media-white'>設立:</p>
                                    <p className='text-media-black text-lg sm:pl-2 dark:text-media-white'>2021年11月</p>
                                </div>
                                <div className='pb-3 leading-loose sm:flex sm:pb-0'>
                                    <p className='font-medium text-media-black text-lg dark:text-media-white'>従業員数:</p>
                                    <p className='text-media-black text-lg sm:pl-2 dark:text-media-white'>9名</p>
                                </div>
                                <div className='pb-3 leading-loose sm:flex sm:pb-0'>
                                    <p className='font-medium text-media-black text-lg dark:text-media-white'>主な取引先(敬称略):</p>
                                    <p className='text-media-black text-lg sm:pl-2 dark:text-media-white'>独立行政法人国際協力機構(JICA)</p>
                                </div>
                                <div className='pb-3 leading-loose sm:flex sm:pb-0'>
                                    <p className='font-medium text-media-black text-lg dark:text-media-white'>関連会社:</p>
                                    <p className='text-media-black text-lg sm:pl-2 dark:text-media-white'>株式会社国際協力データサービス</p>
                                </div>
                                <div className='flex flex-col leading-loose pt-12'>
                                    <p className='text-left font-medium text-media-black text-lg sm:text-center dark:text-media-white'>会社沿革:</p>
                                    <p className='text-left text-media-black text-lg pl-5 sm:text-center dark:text-media-white'>2016年より一般派遣事業者内業務受託チームとして映像制作支援事業を担当</p>
                                    <p className='text-left text-media-black text-lg pl-5 sm:text-center dark:text-media-white'>2021年11月 株式会社ICDSメディアアシストを設立</p>
                                    <p className='text-left text-media-black text-lg pl-5 sm:text-center dark:text-media-white'>2024年 4月　コンテンツ事業課を設置</p>
                                    <p className='text-left text-media-black text-lg pl-5 sm:text-center dark:text-media-white'>2024年 6月　株式会社メディアアシストへ社名変更、所在地を豊島区東池袋へ移転</p>
                                </div>
                            </div>
                        </div>
