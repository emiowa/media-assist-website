export default {
    ...
    artistsCategoryIllustrator: 'Illustrator',
    artistsCategoryManga: 'Manga Artist',
    artistsCategoryDesigner: 'Designer',
    artistsCategoryAnimator: 'Animator',
    artistName_1: 'Alala',
    artistPresentation_1: 'Born in Saga, living in Chiba Japan.<br>Learned Manga and Illustration at Yoyogi Animation School in Fukuoka.<br>Won the Monthly prize for good artists of Young Magazine twice.<br>While working for the firm, posting fan arts works on SNS as well.'
}