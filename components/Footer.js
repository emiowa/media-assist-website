...
export default function Footer(){
	return (
			<div className="bg-media-black rounded-se-bglg">
                <div className='mx-auto flex max-w-7xl px-2 sm:px-24 sm:py-24'>
                    <div className='w-full'>
                        <div className='sm:pb-16'>
                            <p className='text-media-white text-4xl font-black sm:pb-2'>Media Assist</p>
                            <p className='text-media-white text-2xl font-medium'>みんなのメディアを作る会社</p>
                        </div>
                        <div>
                            <p className='text-media-white text-base sm:pb-2'>〒170-6045　東京都豊島区東池袋3-1-1　サンシャイン60 45階</p>
                            <p className='text-media-white text-base'>Tel: (03)5957-7244</p>
                        </div>
                    </div>
