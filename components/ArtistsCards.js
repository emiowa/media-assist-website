...
const ArtistsCards = ({ id, artistName, illustration, portfolioPdf, category, artistPresentation, onClick, showButton = true, index }) => {
  ...
  return (
    <div className='rounded-xl w-80 drop-shadow-lg shadow-lg bg-slate-50 transform scale-100 transition-transform duration-300 ease-in-out hover:scale-105 hover:cursor-pointer' onClick={() => onClick(id)}>
        ...
        <div className='flex justify-center pt-4 pb-5 px-6 z-10 bg-slate-50 rounded-b-xl dark:bg-gradient-to-tr dark:from-indigo-200 dark:to-indigo-100'>
